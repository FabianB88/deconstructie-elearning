...
/**
 * Opslag voor het deconstructie-canvas.
 *
 * De invulvelden op de canvaspagina zijn gewone textarea's in een text-component,
 * geen vraagcomponent. Dat is bewust: een vraagcomponent zou de tekst als goed of
...
const SLEUTEL = 'deconstructie-canvas-v1';
...
class DeconstructieCanvas extends Backbone.Controller {
   ...
   */
  alsTekst() {
    const regels = ['MIJN DECONSTRUCTIE', ''];
...
export default new DeconstructieCanvas();
